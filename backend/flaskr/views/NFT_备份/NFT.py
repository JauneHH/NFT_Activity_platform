...
def nft_information_get():
    ...
    data['signature'] = user_NFT.signature
...
def Get_NFT():
    ...
    print(NFT_name)
    # all_the_text = open('/Users/huangzexi/PycharmProjects/end_demo11.28/flaskr/static/NFT/QRcode/' + NFT_name,
    #                     'rb').read()
    all_the_text = open('/root/myflask/flaskr/static/NFT/QRcode/' + NFT_name,
                        'rb').read()
